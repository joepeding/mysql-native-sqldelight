package nl.joepeding.sqldelight.mysql.native.dialect
...
class MysqlNativeDialect : SqlDelightDialect by MySqlDialect() {
    override val runtimeTypes: RuntimeTypes = RuntimeTypes(
        ClassName("nl.joepeding.sqldelight.mysql.native.driver", "MySQLCursor"),
        ClassName("nl.joepeding.sqldelight.mysql.native.driver", "MySQLPreparedStatement"),
    )
